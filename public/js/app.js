...
let respomsive_menu = document.querySelector('#responsive1')
let hamburger = document.querySelector('#hamburger-menu1')
let close_btn = document.querySelector('#close_menu1')
...
let imgmain55 = document.querySelector('.main-img55')
let salom55 = document.querySelector('.salom55')
imgmain55.addEventListener('click', function () {
    salom55.classList.toggle('hidden')
    imgmain55.classList.toggle('rotate-180')
    text.classList.toggle('hidden')
})

if( document.querySelector('.main-img56')){
    let imgmain56 = document.querySelector('.main-img56')
    let salom56 = document.querySelector('.salom56')
    imgmain56.addEventListener('click', function () {
        salom56.classList.toggle('hidden')
        imgmain56.classList.toggle('rotate-180')
        text.classList.toggle('hidden')
    })
}
...
imgmain6.addEventListener('click', function () {
    ...
    imgmain6.classList.toggle('rotate-180')
...
let respomsive_menu1 = document.querySelector('#responsive1')
let hamburger1 = document.querySelector('#hamburger-menu1')
let close_btn1 = document.querySelector('#close_menu1')
