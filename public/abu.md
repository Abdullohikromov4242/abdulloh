...
<body>
  ...
  <section class=" hidden pb-20  pl-5 pr-5 animate__animated animate__zoomIn ">
    <div class="max-w-[1200px] mx-auto md:-mt-[640px] ">
      ...
      <div class="md:bg-blue-700 md:max-w-[605px] rounded-xl md:-mt-20    ">
        ...
        <div class="pl-5 pr-5">
          <button
            class="  text-[#006AFF ]  mt-[20px] pt-[22px] pb-[22px] w-full  md:bg-white md:text-black rounded-3xl mb-[24px] bg-blue-700 text-white  hover:text-white transition-all hover:bg-blue-500   ">Получить
            консультацию</button>
        </div>
      </div>
    </div>
  ...
  <section class=" hidden  max-w-[1200px] mx-auto mt-[80px] pb-20 pl-5 pr-5 ">
    ...
    <div class=" grid grid-cols-3 gap-6 ">
      ...
      <div class="md:block col-span-1 w-full hidden">
        <img class="pt-16 w-full h-[567px] block  animate__animated   animate__backInRight  " src="./img/log.png"
          alt="">
      </div>
    </div>
    <div class=" grid grid-cols-3 gap-6 ">
      ...
      <div
        ...
        <div class=" flex items-center justify-between ">
          ...
          <img class="main-img1 md:hidden line-clamp-none  " src="./img/Frame (4).png" alt="">
        </div>
        <p class="font-medium text-xl pt-6   md:line-clamp-none   ">Компьютерное зрение представляет собой разработку и
          внедрение
          инновационных
    ...
    <div class=" grid grid-cols-3 gap-6 ">
      ...
      <div class="md:block col-span-1 w-full hidden">
        <img class="pt-16 w-full h-[567px] block animate__animated   animate__backInRight  " src="./img/Group (1).png"
          alt="">
      </div>
    </div>
    <div class=" grid grid-cols-3 gap-6 ">
      ...
      <div
        ...
        <div class=" flex items-center justify-between ">
          <h3 class="font-semibold text-3xl pt-10">Автоматизация процессов</h3>
          <img class="main-img3 md:hidden line-clamp-none  " src="./img/Frame (4).png" alt="">
        </div>
        <p class="font-medium text-xl pt-6   md:line-clamp-none   ">Компьютерное зрение представляет собой разработку и
          внедрение
          инновационных
  ...
  <section class=" hidden  max-w-full mx-auto  pt-20 pb-20 bg-[#091D37]">
    <div class="max-w-[1200px] mx-auto">
      <h2 class="font-semibold md:text-6xl text-3xl text-white  animate__animated animate__backInDown  pl-5 pr-5">Этапы разработки <br>
  ...
  <section class=" hidden mb-20 px-[20px] md:px-0">
    ...
    <div class="">
      ...
      <hr class="max-w-[1200px] animate__animated  animate__backInUp mx-auto">
      <div class="max-w-[1200px] pt-10 mx-auto md:flex justify-between  mb-20 animate__animated  animate__backInUp ">
        <div class="bg-green-40">
          <img src="./img/Group 37 (2).png" alt="">
          <h3 class="font-semibold text-4xl max-w-[588px] mb-5">Высокая <br>
            эффективность</h3>
        </div>
        <div>
          <p class="md:max-w-[588px] max-w-[288px]:  ">Искусственный интеллект способен значительно облегчить процесс
            принятия решений,
            предоставив ценную информацию и рекомендации на основе имеющихся данных. Благодаря алгоритмам искусственного
            интеллекта, огромные объемы информации могут быть проанализированы для выявления закономерностей и
            тенденций, что в свою очередь помогает компаниям формировать более обоснованные мнения. Например, система
            искусственного интеллекта может помочь розничным продавцам определить наиболее прибыльные продукты для
            хранения на основе информации о предыдущих сделках. Еще одним важным применением искусственного интеллекта
            является его способность прогнозировать тенденции запросов и соответственно оптимизировать инвестиции
            финансовых учреждений.</p>
        </div>
      </div>
    </div>
    <hr class="max-w-[1200px] mx-auto animate__animated  animate__backInUp ">
  </section>
  <section class=" hidden max-w-[1200px] mx-auto pl-5 pr-5">
    <div class="mb-20  ">
      <h2 class="font-semibold text-6xl ">Реализованные проекты</h2>
    </div>
    <div>
      <div>
        <section class=" hidden hero">
          <div class="hero-continer max-w-[1200px] mx-auto">
            <div class="swiper mySwiper">
              <div class="swiper-wrapper scale-100">
                <div class="swiper-slide scale-0.8  transition-all  scale-x-100"> <img
                    class="scale-x-100 swipper-img w-full h-[300px] scale-0.8 object-cover transition-all "
                    src="./img/Rectangle 8 (1).png  " alt=""> </div>
                <div class="swiper-slide scale-0.8  transition-all  scale-x-100"> <img
                    class="scale-x-100 swipper-img w-full h-[300px] scale-0.8 object-cover transition-all "
                    src="./img/Rectangle 9.png " alt=""> </div>
                <div class="swiper-slide scale-0.8  transition-all  scale-x-100"> <img
                    class="scale-x-100 swipper-img w-full h-[300px] scale-0.8 object-cover transition-all "
                    src="./img/Rectangle 10.png" alt=""> </div>
                <div class="swiper-slide scale-0.8  transition-all  scale-x-100"> <img
                    class="scale-x-100 swipper-img w-full h-[300px] scale-0.8 object-cover transition-all "
                    src="./img/Rectangle 8 (1).png" alt=""> </div>
                <div class="swiper-slide scale-0.8  transition-all  scale-x-100"> <img
    ...
    <div class="md:flex    items-center max-w-[1200px] mx-auto gap-[80px]">
      <div class="max-w-[720px]  ">
        ...
        <p class="max-w-[720px] pt-[64px] font-medium text-xl mb-5">Команда профессионалов Смарт Спейс Лаб
          ...
          Наша цель - помочь компаниям сэкономить деньги, оптимизировать процессы и принимать более качественные
